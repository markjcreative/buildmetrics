/**
 * upgrade-modal.js — Reusable upgrade gate modal for BuildMetrics
...
const UpgradeModal = (() => {
    ...
    const COPY = {
        ...
        generic: {
            headline: 'Upgrade to BuildMetrics Pro',
        ...
        overlay.innerHTML = `
            <div id="upgrade-modal-box">
                <div class="um-header">
                    ...
                    <div class="um-sub" id="um-sub">Unlock the full power of BuildMetrics.</div>
                </div>
                <div class="um-body">
                    <div class="um-plans">
                        <div class="um-plan">
